class Program
{
    static void Main()
    {
        ...
        // Obtener los números que están en el primer conjunto pero no en el segundo
        HashSet<int> difference = GetDifference(set1, set2);

        // Mostrar los números de la diferencia
        Console.WriteLine("Números que están en el primer conjunto pero no en el segundo:");
