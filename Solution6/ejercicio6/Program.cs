class Program
{
    static void Main()
    {
        ...
        // Obtener los números que están en el segundo conjunto pero no en el primero
        HashSet<int> difference = GetDifference(set2, set1);

        // Mostrar los números de la diferencia
        Console.WriteLine("Números que están en el segundo conjunto pero no en el primero:");
    ...
    static HashSet<int> GetDifference(HashSet<int> set1, HashSet<int> set2)
    {
